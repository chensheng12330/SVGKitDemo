...
@interface DetailViewController : UIViewController <SVGKImageDelegate, UIPopoverControllerDelegate, UISplitViewControllerDelegate , CALayerExporterDelegate, UIScrollViewDelegate>
