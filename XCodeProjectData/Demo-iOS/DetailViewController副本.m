...
-(void) deselectTappedLayer
{
	if( lastTappedLayer != nil )
	{
...
#endif
		{
            ...
            lastTappedLayer.backgroundColor= [UIColor colorWithRed:1 green:0 blue:0 alpha:.5].CGColor;
		}
...
-(void) handleTapGesture:(UITapGestureRecognizer*) recognizer
{
    ...
    CALayer *newLay = [[CALayer alloc] init];
    newLay.frame = CGRectMake(0, 0, hitLayer.frame.size.width, hitLayer.frame.size.height);
    newLay.backgroundColor = [UIColor colorWithRed:1 green:0 blue:0 alpha:0.5].CGColor;
    [hitLayer addSublayer:newLay];
    [self.view setNeedsDisplay];
    [self.contentView setNeedsDisplay];
    /*
    //hitLayer.backgroundColor = [UIColor colorWithRed:1 green:0 blue:0 alpha:0.5].CGColor;
    [hitLayer setNeedsDisplay];
    [hitLayer needsDisplay];
    [hitLayer needsLayout];
    [hitLayer layoutSublayers];
     */
    return;
...
{
    self.svgTool  = [[SHSVGTool alloc] initWithSVGKImage:self.svgImage];
    NSLog(@"svg Loder OK.");
}
