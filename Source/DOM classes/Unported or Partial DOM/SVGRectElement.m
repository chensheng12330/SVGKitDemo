...
void CGPathAddRoundedRect1 (CGMutablePathRef path, CGRect rect, CGFloat radiusX, CGFloat radiusY);
...
- (void)postProcessAttributesAddingErrorsTo:(SVGKParseResult *)parseResult {
	...
	else
	{
		...
		CGPathAddRoundedRect1(path, rect, radiusXPixels, radiusYPixels);
	}
