...
@protocol SVGKImageDelegate <NSObject>
...
@property (nonatomic, retain, readonly) SVGKSource* source; //svg数据流源
...
@property (nonatomic, assign) CALayer* bakTree;
@property (nonatomic, assign) id<SVGKImageDelegate> delegate;
